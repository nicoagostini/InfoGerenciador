...
<div class="container-fluid">
	<div class="row">
		<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			...
			<h1 class="page-header">Dados do orçamento</h1>
				...
				<table id="produtos" class="display">
					...
					<tbody>
						...
						foreach ($todos as $um) {
							...
							echo "<td width='10%'><a href='adicionarProdutoO.php?id=".$um[0]."&p=".$um[7]."'>Adicionar</td>";
							echo "</tr>";
				...
				<tbody>
					...
					foreach($todosf as $umf){
						...
						<tr>
							...
							<td width="8%"><a href="adicionarClienteO.php?id=<?php echo $umf[0];?>&tipo=cf">Selecionar</a></td>
						</tr>
						<?php
					}
					?>
				...
				<tbody>
					...
					foreach($todosj as $umj){
						...
						<tr>
							...
							<td width="8%"><a href="adicionarClienteO.php?id=<?php echo $umj[0];?>&tipo=cj">Selecionar</a></td>
						</tr>
						<?php
					}
				}
		...
		<form action="finalizarOrcamento.php" method="post">
